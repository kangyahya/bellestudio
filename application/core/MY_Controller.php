...
class MY_Controller extends CI_Controller
{
	...
	function render($view, $head, $data=null, $footer=null){
		$vars = $this->loadVars();
		$this->load->vars($vars);
		$all_categories = $this->global->getPaketCategories();
		...
		$this->load->view($this->template . '_partials/filecss',$head);
		$this->load->view($this->template . $view,$data);
		$this->load->view($this->template . '_partials/footer',$footer);
